...
namespace IrrlichtNETCP.Inheritable
{
	...
	public class IGUIElement : GUIElement
	{
		...
		public IGUIElement(IntPtr raw) : base (raw)
		{
		}
...
#region Managed => Unmanaged
		...
		public override bool Enabled {
			...
			set { CGE_PVOID_METHODS(_raw, CGE_VOID_METHOD.SET_ENABLED, IntPtr.Zero, 
		...
		public override bool Noclip {
			get { return CGE_PINT_METHODS(_raw, CGE_INT_METHOD.GET_NOCLIP, IntPtr.Zero, 0,
				                              0, null)==0?false:true; }
			set { CGE_PVOID_METHODS(_raw, CGE_VOID_METHOD.SET_NOT_CLIPPED, IntPtr.Zero,
				                        value == true? 1 : 0, 0, null);}
		}
