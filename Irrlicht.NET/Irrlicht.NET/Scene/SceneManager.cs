...
{
	public class SceneManager : NativeElement
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		public TerrainSceneNode AddTerrainSceneNode(string heightMap, SceneNode parent, int id, Vector3D position, Vector3D rotation, Vector3D scale, Color vertexColor, int maxLOD, TerrainPatchSize patchSize)
		{
			IntPtr par = IntPtr.Zero;
			if(parent != null)
				par = parent.Raw;
        ...
        {
            SceneManager_LoadScene(_raw, filename);
        }
