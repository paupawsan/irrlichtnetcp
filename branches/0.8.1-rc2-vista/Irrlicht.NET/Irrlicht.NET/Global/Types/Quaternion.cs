      ...
      public Matrix4 Matrix
        {
            get {
                ...
                m.M[0]  = 1.0f - 2.0f * m_y * m_y - 2.0f * m_z * m_z;
                m.M[1]  = 2.0f * m_x * m_y + 2.0f * m_z * m_w;
                m.M[2]  = 2.0f * m_x * m_z - 2.0f * m_y * m_w;
                m.M[3]  = 0.0f;

                m.M[4]  = 2.0f * m_x * m_y - 2.0f * m_z * m_w;
                m.M[5]  = 1.0f - 2.0f * m_x * m_x - 2.0f * m_z * m_z;
                m.M[6]  = 2.0f * m_z * m_y + 2.0f * m_x * m_w;
                m.M[7]  = 0.0f;

                m.M[8]  = 2.0f * m_x * m_z + 2.0f * m_y * m_w;
                m.M[9]  = 2.0f * m_z * m_y - 2.0f * m_x * m_w;
                m.M[10] = 1.0f - 2.0f * m_x * m_x - 2.0f * m_y * m_y;
                m.M[11] = 0.0f;
